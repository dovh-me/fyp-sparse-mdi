...
class TinyImageNetOOD(Dataset):
    ...
    def load_val_labels(self):
        ...
        with open(annotations_file, "r") as f:
            ...
            #     image_path = os.path.join(self.tiny_imagenet_dir, "val", "images", image_name)
                # val_images.append(image_path)
                # val_labels.append(class_id)

        # Convert class ID to numeric labels
        # class_to_idx = {class_name: idx for idx, class_name in enumerate(sorted(set(labels)))}
